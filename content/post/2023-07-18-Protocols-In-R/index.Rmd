...
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, fig.align = "center",out.width = "120%")
library(tidyverse)
```
...
```{r,standard,fig.align='center'}
library(tidyverse)
knitr::kable(bradford,align="lccc")
```
